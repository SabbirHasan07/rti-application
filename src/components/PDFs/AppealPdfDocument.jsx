      ...
      <Page size="A4" style={styles.page}>
        ...
        >
          ...
          <Text style={{ maxWidth: 200 }}>
            {appealData?.apealOfficerAddress}
          </Text>
        </View>
        <View
          style={{
        ...
        <Text style={{ textAlign: "center", fontWeight: "bold" }}>
          বিষয়ঃ তথ্য অধিকার আইন, ২০০৯-এর ধারা-২৪ অনুযায়ী আপীল।{" "}
        </Text>
        <View
          style={{
            display: "flex",
        ...
        >
          ...
          <Text style={{ textAlign: "justify" }}>
            নিম্নেস্বাক্ষরকারী গত,{" "}
            <Text>
              {formatBanglaDateFromISO(appealData?.application?.createdAt)}
            </Text>{" "}
            তারিখে দায়িত্ব প্রাপ্ত তথ্য কর্মকর্তা,{" "}
            <Text style={{ fontWeight: "bold" }}>
              {appealData?.informationGivenOfficer}
            </Text>{" "}
            - বরাবর তথ্য অধিকার আইন, ২০০৯-এর ধারা ৮(৩) অনুযায়ী নির্ধারিত ফরমেটে{" "}
            <Text>{appealData?.application?.data?.infoType}</Text> তথ্য চেয়ে
            আবেদন জানায় (সংযুক্ত)।
          ...
          <Text style={{ textAlign: "justify", lineHeight: 1 }}>
            {getSection({
              ...
              infoType: feedbackData?.infoType,
              appealData: appealData,
            })
              .split(" ")
              .map((item, index) => (
                <Text style={{ textAlign: "justify" }} key={index}>
                  {item}{" "}
                </Text>
              ))}
          </Text>
          <Text style={{ textAlign: "justify" }}>
            এমতাবস্থায় নিম্নস্বাক্ষরকারীতথ্য অধিকার আইন, ২০০৯-এর ধারা ২৪ অনুযায়ী{" "}
            <Text>{appealData?.appealOfficer}</Text> - এর আপীল কর্মকর্তা হিসেবে
            আপনার বরাবরে নির্ধারিত ফরমেটে আপীল আবেদন প্রেরণ করছে এবং ধারা ২৪ (৩)
            অনুযায়ী তথ্য সরবরাহের জন্য সংশ্লিষ্ট দায়িত্বপ্রাপ্ত কর্মকর্তাকে
            চাহিদা মাফিক তথ্যগুলি ১৫ দিনের মধ্যে নিম্নস্বাক্ষরকারী বরাবর
            প্রেরণের নির্দেশ প্রদানের জন্য আপনাকে অনুরোধ জানাচ্ছে।।
        ...
        <Text style={{ textAlign: "justify" }}>
          অনুলিপি: সদয় অবগতি ও প্রয়োজনীয় ব্যবস্থা গ্রহণের জন্য প্রেরিত হলো{" "}
        </Text>
        <Text style={{ textAlign: "justify" }}>
          ১। {appealData?.informationGivenOfficer}{" "}
        </Text>
      </Page>
      <Page size="A4" style={styles.page}>
        <View
        ...
        >
          ...
          <Text style={{ lineHeight: 0.9, color: "gray", fontSize: 10 }}>
        ...
        <View>
          ...
          >
            ...
            <Text style={{ width: "50%", textAlign: "justify" }}>
              : এই মর্মে প্রত্যয়ন করা যাচ্ছে যে, উপরে বর্ণিত সমস্ত তথ্য সত্য ও
              বিদ্বেষ প্রসূত নয়{" "}
            </Text>
          </View>
          <View
